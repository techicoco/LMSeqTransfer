...
if __name__ == '__main__':
    folder_ref = '/home/workspace/dataset/z_train/raw/Dataset112_FeTS16t2NCR/labelsTs'
    folder_pred = '/home/workspace/dataset/z_train/inference/seq/paths112'
    output_file = '/home/workspace/dataset/z_train/inference/seq/paths112/summary.json'
    image_reader_writer = SimpleITKIO()
    file_ending = '.nii.gz'
    regions = labels_to_list_of_regions([1, 1])
    ignore_label = None
    num_processes = 12
